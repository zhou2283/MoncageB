...
namespace SCPE
{
    public class Installer : Editor
    {
        ...
        public class Demo
        {
            ...
            public static void FindPackage()
            {
                ...
                if (assets.Length > 0)
                {
                    PACKAGE_PATH = AssetDatabase.GUIDToAssetPath(assets[0]);
                    HAS_PACKAGE = true;
                }
                else
                {
            ...
            {
                INSTALLED = AssetDatabase.IsValidFolder(SCPE.PACKAGE_ROOT_FOLDER + "_Demo/");
    ...
    public class PostProcessingInstallation
    {
        ...
        public static string INSTALL_ID = "com.unity.postprocessing@2.0.14-preview";
