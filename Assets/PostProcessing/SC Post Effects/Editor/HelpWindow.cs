    ...
    public class HelpWindow : EditorWindow, IHasCustomMenu
    {
        ...
        void DrawInstallation()
        {
            ...
            using (new EditorGUILayout.VerticalScope())
            {
                ...
                {
                    /*
                    bool a = (PostProcessingInstallation.Config == PostProcessingInstallation.Configuration.GitHub);
                    bool b = (PostProcessingInstallation.Config == PostProcessingInstallation.Configuration.PackageManager);
                    bool m_left = a;
                    bool m_right = b;

                    SCPE_GUI.DrawSwitchBox(new GUIContent("Configuration", EditorGUIUtility.IconContent("Camera Gizmo").image), "GitHub", "Package Manager",
                    ...
                    if (m_left != a)
                    {
                        Installer.ConfigureShaderPaths((a == true) ? PostProcessingInstallation.Configuration.GitHub : PostProcessingInstallation.Configuration.PackageManager);
                    }
