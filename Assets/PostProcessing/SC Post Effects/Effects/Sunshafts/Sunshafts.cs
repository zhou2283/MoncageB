...
namespace SCPE
{
    ...
    public sealed class Sunshafts : PostProcessEffectSettings
    {
        ...
        public BoolParameter useCasterColor = new BoolParameter { value = false };
        ...
        public FloatParameter sunShaftIntensity = new FloatParameter { value = 1.5f };
        [Range(0.1f, 1f)]
        ...
        public FloatParameter length = new FloatParameter { value = 2.5f };
