...
////// Lighting:
////// Emissive:
                float3 emissive = (_Emission.rgb+(_Tint.rgb*_MainTex_var.rgb));
                float3 finalColor = emissive;
                outDiffuse = half4( 0, 0, 0, 1 );
                outSpecSmoothness = half4(0,0,0,0);
                outNormal = half4( normalDirection * 0.5 + 0.5, 1 );
                outEmission = half4( (_Emission.rgb+(_Tint.rgb*_MainTex_var.rgb)), 1 );
                #ifndef UNITY_HDR_ON
